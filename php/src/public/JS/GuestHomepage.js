            ...
            <div class="jobvacancy-info">
                ...
                <div>
                    <div class="job-name-date">
                        <a href="/detailLowonganGuest?lowonganId=${jobData.lowongan_id}">${job.posisi}</a>
                        <span>Posted on ${new Date(jobData.created_at).toLocaleDateString()}</span>
                    </div>
                    <div class="comp">
                        <p class="comp-name">
                    ...
                    <p class="job-desc">${jobData.deskripsi}</p>
                    <p class="job-loc">${jobData.jenis_pekerjaan} • ${jobData.jenis_lokasi}</p>
                </div>
            </div>
        `;
