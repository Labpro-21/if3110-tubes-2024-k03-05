...
<head>
    ...
    <link rel="stylesheet" href="../public/CSS/guestHomepage.css">
</head>
    ...
    <!--                            <img src="--><?php //= htmlspecialchars($item['image'], ENT_QUOTES, 'UTF-8') ?><!--" alt="--><?php //= htmlspecialchars($item['posisi'], ENT_QUOTES, 'UTF-8') ?><!--">-->
                                <div class="jobvacancy-info">
                                    <div class="job-name-date">
                                        <a href="/detailLowonganGuest?lowonganId=<?= $item['lowongan_id']?>"><?= $item['posisi']?></a>
                                        <span>Posted on <?= date('F j, Y', strtotime($item['created_at'])) ?></span>
                                    </div>
                                    <div class="comp">
                                        <p class="comp-name"><?= $item['nama'] ?></p>
                                    </div>
                                    <p class="job-desc"><?= htmlspecialchars_decode($item['deskripsi']) ?></p>
                                    <p class="job-loc"><?= $item['jenis_pekerjaan'] ?> <span>•</span> <?= $item['jenis_lokasi'] ?></p>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
