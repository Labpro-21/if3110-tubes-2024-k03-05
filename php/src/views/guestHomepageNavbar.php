    ...
    <nav>
        <div class="logo-search">
            ...
            <form action="/dashboard" method="GET" class="search-bar">
                <input type="search" name="search" placeholder="Search jobs" class="form-control" autocomplete="off" value="<?= htmlspecialchars($_GET['search'] ?? '', ENT_QUOTES, 'UTF-8') ?>" id="searchInput"/>
